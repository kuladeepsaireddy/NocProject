...
HD_PWD='D:/mygit/NocProject/hw/Vivado/project_noc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nbyn_full.vds -m64 -mode batch -messageDb vivado.pb -notrace -source nbyn_full.tcl
