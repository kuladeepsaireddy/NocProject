...
HD_PWD='D:/mygit/NocProject/hw/Vivado/project_noc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nbyn_full.vdi -applog -m64 -messageDb vivado.pb -mode batch -source nbyn_full.tcl -notrace
