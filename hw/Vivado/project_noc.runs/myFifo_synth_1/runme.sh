...
HD_PWD='D:/mygit/NocProject/hw/Vivado/project_noc.runs/myFifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myFifo.vds -m64 -mode batch -messageDb vivado.pb -notrace -source myFifo.tcl
