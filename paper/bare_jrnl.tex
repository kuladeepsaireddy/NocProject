...
\title{FPGA based implementation of Network-on-chip for efficient distributed computing}
%
%
...
\author{Dr.Vipin Kizheppatt,
     Kuladeep Sai Reddy }       % <-this % stops a space
...
\subsubsection{}
The following table contains the results for Noc that has  both switch and Pe\\
...
\hline
\multicolumn{4}{|c|}{Resource Utilization} \\
\hline
...
\begin{tabular}{ |p{1cm}|p{1cm}|p{1cm}|p{1cm}|  }
\hline
\multicolumn{3}{|c|}{Timing Report} \\
\hline
Size of architecture& Size of Input in bits & Minimum Period Required(ns) \\
\hline
2x2 & 8 & 0.750\\
2x2 & 32 & 0.750 \\
2x2 & 64 & 0.750 \\
...
\subsubsection{}
The following table contains the results for Noc that has  only switch\\
\begin{tabular}{ |p{1cm}|p{1cm}|p{1cm}|p{1cm}|  }
\hline
\multicolumn{4}{|c|}{Resource Utilization} \\
\hline
